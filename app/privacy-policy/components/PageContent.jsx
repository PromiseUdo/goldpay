      ...
      <Container>
        <div className="w-full">
          <div className="flex flex-col mt-2 gap-4">
            <h3 className="text-4xl my-3">Privacy Policy</h3>
            <h4 className="text-lg font-semibold">Personal information</h4>

            <p>
              We collect personal information from Users when Users fill out a
              loan application form or the contact form for inquiries. Users may
              be asked for, as appropriate, name, email address, home address.
              ...
              may prevent them from applying for our services.
            </p>
            <h4 className="text-lg font-semibold">Non-personal information</h4>
            <p>
            ...
            {/* <h4 className="text-lg font-semibold">Web browser cookies</h4>
Our Site may use "cookies" to enhance User experience. User's web browser places cookies on their hard drive for record-keeping purposes and sometimes to track information about them. User may choose to set their web browser to refuse cookies, or to alert you when cookies are being sent. If they do so, note that some parts of the Site may not function properly. */}
            ...
            <p>
              Goldpay Investment may collect and use Users personal information
              ...
              improve customer experience. Information you provide helps us
              ...
              group use the services and resources provided on our Site. To send
              periodic marketing or non-marketing emails. We may use the email
...
Protecting the privacy of the very young is especially important. For that reason, we never collect or maintain information at our Site from those we actually know are under 13, and no part of our website is structured to attract anyone under 13. */}
            ...
            <p>
              {" "}
              Goldpay Investment has the discretion to update this privacy
              policy at any time. When we do, we will post a notification on the
              main page of our Site, revise the updated date at the bottom of
            ...
            <h4 className="text-lg font-semibold">You can Contac us</h4>

            <p>
              {" "}
              If you have any questions about this Privacy Policy, the practices
              of this site, or your dealings with this site, please contact us
              via info@goldpayinvestment.com. You irrevocably submit to the
